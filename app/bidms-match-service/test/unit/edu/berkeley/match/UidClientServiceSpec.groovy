...
class UidClientServiceSpec extends Specification {
    ...
    private static final INPUT_ATTRIBUTE_MAP = [systemOfRecord: 'b', sorObjectKey: 'BB00002', dateOfBirth: '1930-04-20', firstName: 'Pat', lastName: 'Stone']
    private static final EXPECTED_REST_INPUT = '{"systemOfRecord":"b","sorObjectKey":"BB00002","dateOfBirth":"1930-04-20","firstName":"Pat","lastName":"Stone"}'
