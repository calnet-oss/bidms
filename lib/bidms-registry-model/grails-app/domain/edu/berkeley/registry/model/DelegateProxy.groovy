...
@ConverterConfig(excludes = ["delegateProxyPerson", "delegateProxySorObject"])
@LogicalEqualsAndHashCode(excludes = ["delegateProxyPerson"])
class DelegateProxy implements Comparable {
    ...
    static belongsTo = [delegateProxyPerson: Person] // the Person object (and thus uid) of the proxy delegate
    ...
    static mapping = {
        ...
        delegateProxyPerson column: 'delegateProxyUid', sqlType: 'VARCHAR(64)'
